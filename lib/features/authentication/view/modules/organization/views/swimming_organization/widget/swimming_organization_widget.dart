...
class SwimmingOrganizationForm extends StatefulWidget {
  const SwimmingOrganizationForm({super.key});

  @override
  State<SwimmingOrganizationForm> createState() =>
      _SwimmingStateOrganizationForm();
}

class _SwimmingStateOrganizationForm extends State<SwimmingOrganizationForm> {
